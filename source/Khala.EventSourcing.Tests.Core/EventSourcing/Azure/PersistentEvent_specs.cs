namespace Khala.EventSourcing.Azure
{
    ...
    public class PersistentEvent_specs
    {
        ...
        {
            typeof(PersistentEvent).BaseType.Should().Be(typeof(TableEntity));
        }
        ...
        public void GetPartitionKey_returns_combination_of_source_type_name_and_source_id()
        {
            ...
            string actual = PersistentEvent.GetPartitionKey(sourceType, sourceId);
        ...
        {
            MethodInfo mut = typeof(PersistentEvent).GetMethod("GetPartitionKey");
        ...
        public void Create_sets_PartitionKey_correctly()
        {
            ...
            actual.PartitionKey.Should().Be(PersistentEvent.GetPartitionKey(sourceType, domainEvent.SourceId));
        }
